...
class StatusV60Tests(unittest.TestCase):
    ...
    def test_projection_separates_three_lanes_and_counts_completed_sells(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            log.write_text("\n".join([
                json.dumps({"event":"exploration_sell","lane":"wide","pnl":-.1,"strategy_version":"v623-anti-chase-gates"}),
    ...
    def test_server_rendered_monitor_contains_three_lanes_without_script(self):
        data = {"ok": True, "service_active": True, "stale": False, "strategy_version": "v623-anti-chase-gates", "total_completed_trades": 3, "current_strategy_completed_trades": 1, "lanes": {
        ...
        self.assertIn("v623-anti-chase-gates", page)
