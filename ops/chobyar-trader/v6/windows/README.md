...
This folder installs the existing ChobYar web monitor as a Google Chrome app shortcut on a Windows laptop.
...
The shortcut opens `/monitor/` in Chrome app mode. It stores no exchange credentials and exposes no order, cancel, withdrawal, or execution controls.
